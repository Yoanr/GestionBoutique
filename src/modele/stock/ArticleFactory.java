...
public final class ArticleFactory {
    ...
    public Article creerArticle(String []args) {
        ...
        switch (typeArticle) {
            case "stylo":
                return new Stylo(args[1], args[2], Double.parseDouble(args[3]),Stylo.Couleur.valueOf(args[4].toUpperCase()));

            case "ramette":
                return new Ramette(args[1], args[2], Double.parseDouble(args[3]),Double.parseDouble(args[4]), Double.parseDouble(args[5]));
