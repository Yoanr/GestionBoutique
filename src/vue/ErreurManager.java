...
public class ErreurManager {
	...
	public static final String TYPE_VENDABLE_ERROR = "Type inexistant ou arguments du type incorrects";
	public static final String COMMAND_ERROR = "Arguments en ligne de commande incorrect";
